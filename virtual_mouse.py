...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		# distance = sq root((x2-x1)**2 +(y2-y1)**2)
		...
		mouse_relative_x = int((center_x / width) * screen_width)
		mouse_relative_y = int((center_y / height) * screen_height)

		mouse_position = (mouse_relative_x, mouse_relative_y)
